      ...
      <header className="glass-nav sticky top-0 z-50">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <Link href="/" className="flex items-center gap-2.5">
            <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-violet-600 to-indigo-600 text-sm font-bold text-white shadow-lg shadow-violet-500/30">
              U
            </span>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/signup">
              <Button className="shadow-lg shadow-violet-500/25">
                {c.getStarted}
              </Button>
            </Link>
          </div>
      ...
      <main>
        ...
        <section className="border-y border-zinc-200/80 bg-white py-10">
          <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-center gap-x-12 gap-y-4 px-6 text-sm font-medium text-zinc-400">
            {["Stripe", "Global shipping", "Digital delivery", "GDPR-ready"].map(
              (label) => (
          ...
          <div className="mx-auto max-w-6xl px-6">
            <div className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-zinc-600">
                Everything creators and small brands need to launch, sell, and
          ...
          <div className="mx-auto max-w-6xl px-6">
            ...
            <div className="mt-16 grid gap-8 md:grid-cols-3">
              {steps.map((step) => (
                ...
                >
                  <span className="text-4xl font-bold text-violet-500/40">
                    {step.n}
                  </span>
        ...
        <section className="mx-6 mb-24">
          <div className="mx-auto max-w-6xl overflow-hidden rounded-3xl bg-gradient-to-r from-violet-600 to-indigo-600 px-8 py-16 text-center shadow-2xl shadow-violet-500/30 md:px-16">
            ...
            <p className="mx-auto mt-4 max-w-xl text-violet-100">
              Join creators and brands building on UGCLab Store. Your storefront
              is one signup away.
            </p>
      ...
      <footer className="border-t border-zinc-200 bg-white py-12">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 px-6 md:flex-row">
          ...
          <div className="flex gap-6 text-sm text-zinc-500">
            ...
            <a href={`${adminUrl}/login`} className="hover:text-zinc-800">
              Merchant login
            </a>
          </div>
        </div>
